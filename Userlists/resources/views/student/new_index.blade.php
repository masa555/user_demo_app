...
<form action="" method="post" class="form-horizontal">
  ...
  <div class="col-sm-9">
  <input type="text" class="form-control" id="name" name="name"value="{{old('name')}}"placeholder="お名前">
  ...
  <div class="col-sm-9">
  <input type="email" class="form-control" id="email" name="email"value = "{{ old('email') }}" placeholder="メールアドレス">
  ...
  <div class="col-md-9">
  <input type="tel" class="form-control" id="tel" name="tel"value = "{{ old('tel') }}" placeholder="電話番号">
